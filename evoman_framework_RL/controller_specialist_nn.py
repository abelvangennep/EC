...
for en in range(1, 2):
    ...
    pop = [Individual(initialize_network()) for i in range(2)]
    for pcont in pop:
        # Update the enemy
    ...
    #----- Tim -------
    #parents = select_parents(species) This function returns pairs of parents which will be mated. In total
    # the number of pairs equal to the number of offsprings we want to generate
    #----- Abel -------
    #children = crossover(parents) for loop needed to cross each pair of parents
    #-----      -------
