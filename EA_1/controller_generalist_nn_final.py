...
def run_neat(list_):
    ...
    for en in enemy:
        ...
        for gen in range(number_generations): #number of generations
            ...
            pop = children
            print('Generation ', gen, ' took ', time.time()-start_gen, ' seconds to elapse. Highest fitness value was ', max(fitnesses), 'lowest enemy life: ',min(el) )
...
if __name__ == '__main__':
    final_experiment_data(runs = 10, number_generations = 15, population_size = 60, compat_threshold = 8.9, weight_mutation_lambda = 2.4, link_insertion_lambda=0.22, node_insertion_lambda=.49, enemy=[2]) #runs has to be even number
